...
const FirstPage = (props) =>{
    navigationOptions = {title: 'FirstPage',};
    const { navigate } = props.navigation;
    
    const show = () => {
        WSnackBar.show({data: 'Location enabled'})
    }
    return(
        <View style={styles.container}>
            <Swiper controlsProps={{prevPos: false, nextPos: false, dotsPos: false}}>
                    <View style={styles.container}>
                        <ImageBackground source={require('../images/iPhoneX-XS-NAVIX-bg.png')} resizeMode={'stretch'} style={styles.imagen}>
                            <View style={styles.layout}>
                                ...
                                <View style={styles.button}>
                                    <TouchableWithoutFeedback><Image source={require('../icons/Group152.png')} style={{width: 126, height: 25}} /></TouchableWithoutFeedback> 
                                </View>
                            </View>            
                        </ImageBackground>
                    </View>
                    <View style={{flex: 1}}>
                        <ImageBackground source={require('../images/iPhoneX-XS-NAVIX-bg.png')} resizeMode={'stretch'} style={styles.imagen}>
                            <View style={styles.layout}>
                                ...
                                <View style={styles.button}>
                                <TouchableWithoutFeedback><Image source={require('../icons/Group150.png')} style={{width: 126, height: 25}} /></TouchableWithoutFeedback> 
                                </View>
                            </View>
                        </ImageBackground>
                    </View>
                    <View style={{flex: 1}}>
                        <ImageBackground source={require('../images/iPhoneX-XS-NAVIX-bg.png')} resizeMode={'stretch'} style={styles.imagen}>
                            ...
                            <View style={styles.layout}>
                                ...
                                <View style={styles.button}>
                                <TouchableWithoutFeedback onPress={() => navigate('Home')}><Image source={require('../icons/Group151.png')} style={{width: 126, height: 25}} /></TouchableWithoutFeedback> 
                                </View>
                            </View>
